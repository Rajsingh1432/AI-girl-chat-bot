...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    f"<blockquote><b><tg-emoji emoji-id=\"6332268261010315734\">💃</tg-emoji> 𝐌ᴀɪɴ {bot_name} 𝐇ᴜɴ — 𝐓ᴜᴍʜᴀʀɪ 𝐖𝴏 𝐃ᴏsᴛ 𝐉ᴏ 𝐁ᴏʀɪɴɢ 𝐆ʀᴏᴜᴘs 𝐊ᴏ 𝐙ɪɴᴅᴀ 𝐊ᴀʀ 𝐃ᴇᴛɪ 𝐇ᴀɪ</b></blockquote>\n\n"
    ...
    f"<tg-emoji emoji-id=\"6143155267509948558\">✨</tg-emoji> <b>𝐏ᴏᴡᴇʀᴇᴅ 𝐁ʏ 𝐑𝴀𝴊 𝐀ɪ — 𝐓ᴇᴢ, 𝐒ᴍᴀʀᴛ 𝐀ᴜʀ 𝐓ʜᴏᴅᴀ 𝐒ᴀ 𝐃ʀᴀᴍᴀᴛɪᴄ</b> <tg-emoji emoji-id=\"5366073534793671550\">✨</tg-emoji></blockquote>\n\n"
    f"<tg-emoji emoji-id=\"5362079447136610876\">✨</tg-emoji> <b>𝐃ᴇᴠᴇʟᴏᴘᴇ 𝐁ʏ</b> <a href=\"https://t.me/its_raj_king\">𝐑𝴀𝴊 𝐂ʜᴇᴀᴛs 𝐎ᴡɴᴇʀ</a>\n\n"
)
